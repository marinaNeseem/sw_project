...
if (isset($_POST["delete"])) {
  if (!empty($_POST["comment_id"])) {
    if ($commentController->deletecomment($_POST["comment_id"])) {
      $deleteMsg = true;
      $comments=$commentController->getallcomments();
    }
  }
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      ...
      <?php
              if (count($comments) == 0) {
              ?>
                <div class="alert alert-danger" role="alert">No Available comments</div>
              <?php
              } else {
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      ?>
                        <tr>
                          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <?php echo $comments["comment_id"] ?></td>
                          <td><?php echo $comments["user_id"] ?></td>
                          <td>
                            <?php echo $comments['article_id'] ?>
                          </td>
                          <td><?php echo $comments["comment"] ?></td>
                          <td><?php echo $comments["date"] ?></td>
                          
                          <td>
                            <form action="../admin/allcomments.php" method="POST">
