...
if(isset($_POST['user_id']) && isset($_POST['article_id']) && isset ($_POST['comment']) && isset ($_POST['date']) )
{
  if( !empty($_POST['user_id']) && !empty($_POST['article_id']) && !empty($_POST['comment']) && !empty ($_POST['date']) )
  {
   ...
   if( $commentcontroller->add($comment))
    {
      header("location: ../admin/allcomments.php");
    }
    else
    {
      $errMsg="somthing went wrong....try agin";
    }
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="../admin/postarticle.php">
              <i class="bi bi-circle"></i><span>Add Article</span>
            </a>
          </li>
          <li>
    ...
    <section class="section contact">
      ...
      <div class="row gy-4">
        ...
        <div class="col-xl-6">
                ...
                <!--<div class="col-md-6">
                  <input type="text" name="comment_id" class="form-control" placeholder="Your comment id" required>
                </div>-->
                ...
                <div class="col-md-6">
                  <input type="text" name="article_id" class="form-control" placeholder="article id" required>
                </div>
               ...
               <button class="btn btn-primary w-100" type="submit">addcomment</button>
                </div>
                <?php
    if($errMsg !="")
    {
