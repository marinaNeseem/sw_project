...
if(isset($_POST['title']) && isset($_POST['category'])  && isset ($_POST['content']) )
{
  if(!empty($_POST['title']) && !empty($_POST['category'])  && !empty ($_POST['content']) )
  {
    ...
    $article->media=$_POST['media'];
    $article->article_body=$_POST['content']; 
    $article->category=$_POST['category'];
    $location = "../images/" . date("h-i-s") . $_FILES["media"]["name"];
   if( $postcontroller->add( $article))
    {
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">enclocypidea</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
          <a href="../admin/Addcomment.php">
              <i class="bi bi-circle"></i><span>Add comment</span>
            </a>
          </li>
          <li>
